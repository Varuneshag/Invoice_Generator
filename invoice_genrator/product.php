...
;">
	<div class="col-md-12">
		...
		<div class="panel panel-default" style="border: 1.5px solid; padding-bottom: 30px; margin-top: 30px;">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:30px; padding-top: 20px;">
				...
				<table class="" id="manageProductTable" >
					<thead>
						<tr>
