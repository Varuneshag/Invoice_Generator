...
$query1="select * from client_info";
...
<div class="panel panel-default" >
	...
	<div class="panel-body" style="bakground-image: url('images/bg.jpg'); background-repeat: no-repeat;background-size: cover;">
...
<div class="row">
			  <div class="" id="ordername" style="margin-left: -50px;">
			  ...
			  <div style="margin-left:650px;">
			    ...
			    <div class="col-sm-6">
			      <select type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" onchange="pqr(this.value)"  >
		  ...
		  while($row1=mysqli_fetch_assoc($run1))
		  {
			  ...
			  <option id="<?php echo $row1['cname'];?>" value="<?php echo $row1['cphno'];?>"> <?php echo $row1['cname'];?> </option>
...
function pqr(vm)
	{
		...
		document.getElementById("clientContact").value = v;
...
<br><br>
			  <div class="form-group" style="display: none;">
			    ...
			    <div class="col-sm-2">
			      <input type="text" class="form-control " value="" readonly id="clientContact" name="clientContact" placeholder="Contact Number"  />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <table class="table" id="productTable" >
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:10%; padding-left:30px ;">Rate</th>
			  			<th style="width:10%;">Available Quantity</th>
			  			<th style="width:15%;padding-left:60px ;">Quantity</th>			  			
			  			<th style="width:15%;padding-left:30px ;">Total</th>			  			
			  	...
			  	<tbody>
			  		...
			  		for($x = 1; $x < 2; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
							...
							<td style="padding-left:80px; width: 50px;">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Client Contact</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" readonly name="clientContact" placeholder="Contact Number" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->			  
